...
(function () {
  ...
  "sq": {
    ...
    "Run Chain": "Run Chain",
    "Stop": "Stop",
    "Visual editor for multi-step automation chains. Steps connect in sequence; supports templates and custom JavaScript execution.": "Visual editor for multi-step automation chains. Steps connect in sequence; supports templates and custom JavaScript execution.",
    "Dynamic Elements (List, JSON, or function)": "Dynamic Elements (List, JSON, or function)",
    "Chain JSON (advanced):": "Chain JSON (advanced):",
    "Debug mode:": "Debug mode:",
    "Enable debug logging": "Enable debug logging",
    "Batch settings:": "Batch settings:",
    "Process all items in batch": "Process all items in batch",
    "Remove processed items from queue": "Remove processed items from queue",
    "Wait between items (ms):": "Wait between items (ms):",
    "Wait between steps (ms):": "Wait between steps (ms):",
    "Open in new chat before this step": "Open in new chat before this step",
    "Message Template": "Message Template",
    "Template with placeholders like {{item}}, {{index}}, {{total}} or {steps.stepId.data}...": "Template with placeholders like {{item}}, {{index}}, {{total}} or {steps.stepId.data}...",
    "Dynamic Elements (JSON/function). Supports {placeholders}.": "Dynamic Elements (JSON/function). Supports {placeholders}.",
    "Use chain.dynamicElements as elements": "Use chain.dynamicElements as elements",
    "Batch processing: {{item}} for current item, {steps.stepId.response} for previous step data": "Batch processing: {{item}} for current item, {steps.stepId.response} for previous step data",
    "HTTP Request": "HTTP Request",
    "Format JSON": "Format JSON",
    "Request body: {steps.stepId.response} or JSON data": "Request body: {steps.stepId.response} or JSON data",
    "Access response with {steps.thisStepId.data} or {steps.thisStepId.status}. Use previous step data in URL/headers/body.": "Access response with {steps.thisStepId.data} or {steps.thisStepId.status}. Use previous step data in URL/headers/body.",
    "JavaScript Code": "JavaScript Code",
    "Access step data with <code>steps.stepId.data</code> or <code>steps.stepId.response</code>. Use <code>http</code> for API calls, <code>utils.log()</code> for output.": "Access step data with <code>steps.stepId.data</code> or <code>steps.stepId.response</code>. Use <code>http</code> for API calls, <code>utils.log()</code> for output.",
    "Next step": "Next step",
    "Edit Step": "Edit Step",
    "Edit step": "Edit step",
